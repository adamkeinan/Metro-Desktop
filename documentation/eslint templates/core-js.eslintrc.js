...
const base = {
  ...
  "unicorn/catch-error-name": [
    "error",
    { name: "error", caughtErrorsIgnorePattern: "^err" }
  ],
...
const node = {
  ...
  "node/no-unsupported-features/es-builtins": [
    "error",
    { version: SUPPORTED_NODE_VERSIONS }
  ],
...
module.exports = {
  ...
  plugins: ["import", "node", "optimize-regex", "qunit", "sonarjs", "unicorn"],
  settings: {
    "import/resolver": {
      webpack: {
  ...
  overrides: [
    ...
    {
      files: ["tests/helpers/**", "tests/pure/**", "tests/tests/**"],
      env: {
        qunit: true
      },
      rules: qunit
    ...
    {
      files: ["tests/tests/**", "tests/compat/**"],
      env: {
        es6: true
      },
      globals: {
